...
The manuscript was updated to version \textsc{v96.1}\,,
...
\index{The LaTeX Companion@\htmlref{The \textup{\LaTeX} Companion}\label{IIIlatcomp}!Goossens--Mittelbach--Samarin}%
\end{htmlonly}
