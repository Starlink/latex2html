...
\cbversion{96.1h}\begin{changebar}\cbversion{96.1h}
...
\sameas{\fn{\$AUTO\_LINK}\texttt{ = 0;}}\\
If \fn{\$AUTO\_LINK} is set, along with variables \fn{\$LINKPOINT} 
and \fn{\$LINKNAME} (e.g. within the \fn{latex2html.config} file) 
then a hard link to the main \texttt{HTML} page is produced,
using the name in \fn{\$LINKNAME}. Typically this is \fn{index.html}; 
...
\end{changebar}
\strikeout{Currently, versions 2.0, 2.1, 2.2, 3.0 and 3.1 are available.}\\  
...
adequately expressed using (italiced) text characters and \HTML{SUB} and
\HTMLtag{SUP} tags.
...
\cbversion{96.1f}\begin{changebar}\cbversion{96.1f}\noindent
...
\begin{htmllist}\htmlitemmark{MagentaBall}%
%
\index{ascii-mode}% 
...
This is used with the \fn{\$AUTO\_LINK} \htmlref{variable}{noautolink}, 
