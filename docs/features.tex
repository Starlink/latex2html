...
The \texttt{\$GENERIC\_WORDS} are a list of short words excluded
...
Otherwise the browser might render the character as \mbox{\pounds},
...
\textbf{extension}& (notes) & \textbf{encoding}\\\hline
unicode & (partial)& ISO--10646 (Unicode)\\
latin1 & (default) & ISO--8859--1 (ISO-Latin1) \\
latin2 &  & ISO--8859--2 (ISO-Latin2) \\
latin3 &  & ISO--8859--3 (ISO-Latin3) \\
latin4 &  & ISO--8859--4 (ISO-Latin4) \\
latin5 &  & ISO--8859--9 (ISO-Latin5) \\
latin6 &  & ISO--8859--10 (ISO-Latin6)\\\hline
\end{tabular}
...
is fully automated, so that it ibecomes just another step 
